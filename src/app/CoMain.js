...
function CoMain() {
  return (
    <>
      ...
      >
        ...
        <div className="w-full border-y border-gray-400 dark:border-gray-700 overflow-hidden">
          <Image
            ...
            alt="pfp"
            className="w-full py-2 hover:scale-110 delay-150 ease-in duration-150"
          />
        </div>
      ...
      <div className="bg-zinc-200 dark:bg-gray-950 w-full border border-gray-400 dark:border-gray-800 rounded-lg h-48 flex flex-col justify-center items-center my-2">
