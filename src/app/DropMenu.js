    ...
    <>
      <div className="relative">
        ...
        <>
          ...
          >
            <a href="#projects">
              <button className="w-full h-8 rounded-lg hover:bg-gray-300 hover:dark:bg-gray-900" onClick={toggleOpen} >
              Projects
              </button>
            </a>
            <a href="#contact">
            ...
            <button className="w-full h-8 rounded-lg hover hover:bg-green-5000 text-green-500 hover:text-gray-50 flex justify-center items-center gap-2 pr-2 opacity-60" onClick={toggleOpen} ><TbBrandFiverr/> Fiver Profile</button>
            ...
            >
              <button className="w-full h-8 rounded-lg hover hover:bg-pink-500 text-pink-500 hover:text-gray-50 hidden max-lg:block" onClick={toggleOpen} >
                Download CV
              </button>
            </a>
          </div>
